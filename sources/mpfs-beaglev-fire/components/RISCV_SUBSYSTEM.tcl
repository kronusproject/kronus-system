...
sd_create_scalar_port -sd_name ${sd_name} -port_name {CAN_1_TX_EBL_M2F} -port_direction {OUT}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAN_1_RXBUS_F2M" "PF_SOC_MSS:CAN_1_RXBUS_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAN_1_TXBUS_M2F" "PF_SOC_MSS:CAN_1_TXBUS_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAN_1_TX_EBL_M2F" "PF_SOC_MSS:CAN_1_TX_EBL_M2F" }
