...
source ${source_path}/components/SYZYGY/SYZYGY.tcl
source ${source_path}/components/CAPE/CAPE.tcl
source ${source_path}/components/M2/M2.tcl
source ${source_path}/components/MIPI_CSI/MIPI_CSI.tcl
...
# Save and generate the smartdesign
