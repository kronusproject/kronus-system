...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {FABRIC_PERIPHERALS_0:interrupt} -pin_slices {[31:5]}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {FABRIC_PERIPHERALS_0:interrupt[31:5]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_PERIPHERALS_0:interrupt[0:0]" "RISCV_SUBSYSTEM:MSS_INT_F2M_3_7[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_PERIPHERALS_0:interrupt[1:1]" "RISCV_SUBSYSTEM:MSS_INT_F2M_3_7[4:4]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_PERIPHERALS_0:interrupt[2:2]" "RISCV_SUBSYSTEM:MSS_INT_F2M_3_7[5:5]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_PERIPHERALS_0:interrupt[3:3]" "RISCV_SUBSYSTEM:MSS_INT_F2M_3_7[6:6]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FABRIC_PERIPHERALS_0:interrupt[4:4]" "RISCV_SUBSYSTEM:MSS_INT_F2M_3_7[7:7]" }
