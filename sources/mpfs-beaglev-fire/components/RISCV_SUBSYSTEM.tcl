...
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {PF_SOC_MSS:SPI_0_DI_F2M} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {PF_SOC_MSS:SPI_1_DI_F2M} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {PF_SOC_MSS:SPI_0_CLK_M2F} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {PF_SOC_MSS:SPI_0_DO_M2F} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {PF_SOC_MSS:SPI_0_SS1_M2F} -port_name {}
