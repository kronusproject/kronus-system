...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RISCV_SUBSYSTEM:MMUART_4_TXD" "P9_13"}
sd_connect_pins -sd_name ${sd_name} -pin_names {"RISCV_SUBSYSTEM:MMUART_4_RXD" "P9_11"}

#-------------------------------------------------------------------------------

sd_mark_pins_unused -sd_name ${sd_name} -pin_names {RISCV_SUBSYSTEM:CAPE_APB_MTARGET}
...
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[6:6]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[0:0]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[1:1]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[2:2]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[3:3]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[4:4]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[5:5]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[7:7]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[8:8]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[9:9]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[10:10]} -port_name {}
sd_connect_pin_to_port -sd_name ${sd_name} -pin_name {RISCV_SUBSYSTEM:GPIO_2_M2F[11:11]} -port_name {}
